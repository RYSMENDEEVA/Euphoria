  ...
  return (
    <>
      <section className="slider">
        ...
        >
          <SwiperSlide>
            <SliderHead img={summer} />
          </SwiperSlide>
          <SwiperSlide>
            <SliderHead img={summer2} />
          </SwiperSlide>
          <SwiperSlide>
            <SliderHead img={summer3} />
          </SwiperSlide>
        </Swiper>
      </section>
        ...
        <div className="container">
          ...
          <div className="arrivals__row">
            <Swiper
              ...
              className="mySwiper"
            >
              <SwiperSlide onClick={() => navigate('/men')}>
                <Arrivals title="Knitted Joggers" img={arrivals1} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/men')}>
                <Arrivals title="Full Sleeve" img={arrivals2} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/men')}>
                {' '}
                <Arrivals title="Active T-Shirts" img={arrivals3} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/women')}>
                {' '}
                <Arrivals title="Urban Shirts" img={arrivals4} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/men')}>
                {' '}
                <Arrivals title="Urban Shirts" img={arrivals5} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/women')}>
                {' '}
                <Arrivals title="Urban Shirts" img={arrivals6} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/men')}>
                {' '}
                <Arrivals title="Urban Shirts" img={arrivals7} />
              </SwiperSlide>
              <SwiperSlide onClick={() => navigate('/women')}>
                {' '}
                <Arrivals title="Urban Shirts" img={arrivals8} />
              </SwiperSlide>
            </Swiper>
          </div>
        </div>
      ...
      <section className="saving">
        <div className="container">
          <h2 className="saving__title">Big Saving Zone</h2>
          <div className="saving__top">
            <div
              className="saving__top-card top-padding"
              style={{ background: `url(${saving1}) center/cover no-repeat` }}
              onClick={() => navigate('/combos')}
            >
              <a href="#!" className="saving__card-link"></a>
              <p className="saving__card-title">
                Hawaiian <br /> Shirts
              </p>
            ...
            <div
              className="saving__top-card"
              style={{ background: `url(${saving2}) center/cover no-repeat` }}
              onClick={() => navigate('/combos')}
            >
              <a href="#!" className="saving__card-link"></a>
              <p className="saving__card-title">
            ...
            <div
              className="saving__top-card "
              style={{ background: `url(${saving3}) center/cover no-repeat` }}
              onClick={() => navigate('/combos')}
            >
              <a href="#!" className="saving__card-link"></a>
              <p className="saving__card-title text-color">
                Cargo <br /> Joggers
              </p>
              <p className="saving__card-subtitle text-color">
          ...
          <div className="saving__bottom">
            <div
              className="saving__top-card bottom-imgwidth "
              style={{ background: `url(${saving4}) center/cover no-repeat` }}
              onClick={() => navigate('/combos')}
            >
              <p className="saving__card-title text-color">
                Urban <br /> Shirts
            ...
            <div
              className="saving__top-card bottom-imgwidth "
              style={{ background: `url(${saving5}) center/cover no-repeat` }}
              onClick={() => navigate('/combos')}
            >
              <p className="saving__card-title text-color">
      ...
      <section className="better">
        <div className="container">
          <div className="better__row">
            <div
              className="better__left"
              style={{ background: `url(${better1}) center/cover no-repeat` }}
            >
              <h2 className="better__title">
      ...
      <section className="categories">
        <div className="container">
          <h2 className="categories__title">Categories For Men</h2>
          <div className="categories__cards" onClick={() => navigate('/men')}>
      ...
      <section className="categories">
        <div className="container">
          <h2 className="categories__title">Categories For Women</h2>
          <div className="categories__cards" onClick={() => navigate('/women')}>
          ...
          <div className="brands__card">
            <div className="brands__text">
              ...
              <p className="brands__desc">
                Up To <span className="brands__desc-yellow">60%</span> off on
                brands
              </p>
            </div>
            <ul className="brands__list">
              <li>
                <a className="brands__link1" href="#!">
                  <img src={nike} alt="" />
                </a>
              </li>
              <li>
                <a className="brands__link2" href="#!">
                  <img src={hm} alt="" />
                </a>
              </li>
              <li>
                <a className="brands__link3" href="#!">
                  <img src={levis} alt="" />
                </a>
              </li>
              <li>
                <a className="brands__link4" href="#!">
                  <img src={polo} alt="" />
                </a>
              </li>
              <li>
                <a className="brands__link5" href="#!">
                  <img src={puma} alt="" />
                </a>
              </li>
            </ul>
      ...
      <section className="limelight">
        <div className="container">
          <h2 className="limelight__title">In The Limelight</h2>
